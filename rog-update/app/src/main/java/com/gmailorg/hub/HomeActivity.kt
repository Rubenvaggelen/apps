...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Zorgt dat de vaste parkeermelding bij Snackcident geregistreerd staat
        // zodra locatietoestemming beschikbaar is; doet niets als dat al zo is.
        ParkingGeofenceManager.ensureRegistered(this)
    }
