...
object FitnessStore {
    ...
    fun progress(context: Context, today: LocalDate = LocalDate.now()): Progress {
        ...
        val scheduledDays = scheduledTrainingDays(profile?.daysPerWeek ?: 0)
    ...
    private fun scheduledTrainingDays(daysPerWeek: Int) = when (daysPerWeek) {
        2 -> setOf(java.time.DayOfWeek.MONDAY, java.time.DayOfWeek.THURSDAY)
        3 -> setOf(java.time.DayOfWeek.MONDAY, java.time.DayOfWeek.WEDNESDAY, java.time.DayOfWeek.SATURDAY)
        4 -> setOf(java.time.DayOfWeek.MONDAY, java.time.DayOfWeek.TUESDAY, java.time.DayOfWeek.THURSDAY, java.time.DayOfWeek.SATURDAY)
        5 -> setOf(java.time.DayOfWeek.MONDAY, java.time.DayOfWeek.TUESDAY, java.time.DayOfWeek.THURSDAY, java.time.DayOfWeek.FRIDAY, java.time.DayOfWeek.SATURDAY)
        6 -> setOf(java.time.DayOfWeek.MONDAY, java.time.DayOfWeek.TUESDAY, java.time.DayOfWeek.WEDNESDAY, java.time.DayOfWeek.THURSDAY, java.time.DayOfWeek.FRIDAY, java.time.DayOfWeek.SATURDAY)
        else -> emptySet()
    }
