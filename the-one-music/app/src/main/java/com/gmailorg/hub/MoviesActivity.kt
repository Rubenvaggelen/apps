...
class MoviesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.musicSearchButton).setOnClickListener { searchMusicOnYouTube(musicInput.text.toString()) }
        musicInput.setOnEditorActionListener { _, actionId, _ ->
            if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                searchMusicOnYouTube(musicInput.text.toString())
                true
            } else {
                false
            }
    ...
    private fun searchMusicOnYouTube(query: String) {
