...
object GoogleTasksAuth {
    ...
    sealed class SignInResult {
        ...
        data class Failure(val code: Int, val message: String) : SignInResult()
    }
    ...
    fun handleSignInResult(context: Context, data: Intent?): SignInResult {
        return try {
            ...
            if (email != null) {
                ...
                SignInResult.Failure(-1, "Geen e-mailadres ontvangen")
            }
        } catch (e: com.google.android.gms.common.api.ApiException) {
            Log.e(TAG, "Inloggen mislukt: code ${e.statusCode}", e)
            SignInResult.Failure(e.statusCode, e.message ?: "onbekend")
        } catch (e: Exception) {
            Log.e(TAG, "Inloggen mislukt", e)
            SignInResult.Failure(-2, e.message ?: "onbekend")
        }
    }
