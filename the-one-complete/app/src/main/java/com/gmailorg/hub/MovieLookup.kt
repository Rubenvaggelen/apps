...
object MovieLookup {
     ...
     * Kiest niet zomaar de eerste treffer, maar de populairste (meest
     * bekende) — anders wint soms een obscure oude film met toevallig
     * exact dezelfde tekst van de bekende, gezochte titel.
     */
    private fun searchTitle(query: String, apiKey: String): TitleHit? {
        ...
        return hits.maxByOrNull { it.popularity }
    }
